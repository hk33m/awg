        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                منصة تعليمية ذكية لترجمة لغة الإشارة باستخدام تقنيات الذكاء
          ...
          <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-right text-sm text-gray-400">
            <p className="mb-4 md:mb-0">
              © 2026 <span className="font-bold text-cyan-300">اوج</span> - جميع
              الحقوق محفوظة
            </p>
            <p>
              تم التطوير بـ ❤️ من قبل فريق{" "}
              <span className="font-semibold text-blue-300">اوج</span>
            </p>
          </div>
